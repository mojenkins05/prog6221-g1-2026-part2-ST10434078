...
namespace POEProg6221.GUI.Services
{
    ...
    public class ResponseService
    {
        ...
        private void InitialiseDefaultResponses()
        {
            ...
            {
                "I'm not sure I understand. Can you try rephrasing? You can also type 'help' to see the topics I can help with!",
                "I didn't quite catch that. Could you ask about a specific cybersecurity topic like passwords, phishing, or privacy?",
                "Hmm, I'm not familiar with that topic yet. Try asking me about password safety, scams, safe browsing, or two-factor authentication!",
                "I'm still learning! Could you try asking about cybersecurity topics like privacy, malware, Wi-Fi safety, or social media security?",
                "I want to help but I'm not sure what you mean. Type 'help' to see all the topics I can discuss!"
            };
        }
